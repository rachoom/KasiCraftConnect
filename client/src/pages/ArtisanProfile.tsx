      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-black-soft mb-4">Artisan Not Found</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-start space-x-6">
                  <div className="w-24 h-24 bg-gradient-to-br from-gold to-gold-dark rounded-full flex items-center justify-center text-white font-bold text-2xl">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-lg text-gold-dark font-medium mb-3">
                    ...
                    <div className="flex items-center space-x-6 mb-4">
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="font-semibold text-lg">{formatRating(artisan.rating || "0")}</span>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Contact {artisan.firstName}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <div className="flex justify-between">
                    <span>Email:</span>
                    <span className="font-medium break-all">{artisan.email}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="font-semibold">{formatRating(artisan.rating || "0")}</span>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">{artisan.yearsExperience} years</span>
                </div>
